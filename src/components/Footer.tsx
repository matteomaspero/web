    ...
    <footer className="bg-navy text-white">
      <div className="section-container py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Dr. John Smith</h3>
            <p className="text-white/70 mb-4">
              Dedicated to advancing clinical translation through innovative research and education.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#talks" className="text-white/70 hover:text-white transition-colors inline-flex items-center gap-2">
                  <FileText className="h-4 w-4" />
                  Talks
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70">
              ...
              <li>Institute for Clinical Translation</li>
              <li>Society for Medical Education</li>
              <li>International Research Collaborative</li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-white/20 pt-8 text-center text-white/50">
          <p>&copy; {new Date().getFullYear()} Dr. John Smith. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
